...
1. **Create Button**: Press to create a new entry.
2. **Page Size**: Select how many entries to display per page.
3. **Search**: Enter text to search for entries.
4. **View Link**: Open the details of a specific entry.
5. **Pagination**: Use the bar to move between pages.
