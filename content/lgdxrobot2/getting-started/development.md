...
The first publicly released robot is LGDXRobot2, although it may seem unusual that the project starts with **2**. Since the first robot was originally part of another project and was eventually redesigned into LGDXRobot2.
...
The robot ran on an Nvidia Jetson Nano using ROS Melodic, with object detection powered by the [jetson-inference](https://github.com/dusty-nv/jetson-inference) framework. It also has a remote control interface that streamed system status, logs, and live images from the robot.
